...
\ Immediate is not defined like this in SLOTH, just avoid this definition and use my own.
\ 
\ : FLAG_IMMEDIATE 64 ;
\ 
\ : IMMEDIATE
...
: -ROT ( a b c -- c a b )
        rot rot
;
\ JORDI: Another possibility for 3dup without using pick will be:
\ >r >r dup r@ swap r> r@ rot rot r>
